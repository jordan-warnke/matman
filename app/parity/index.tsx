      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <View style={[styles.infoCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          ...
          <Text style={[styles.infoLine, { color: colors.muted }]}>
            Under pressure, even strong test-takers confuse adding odds vs multiplying odds.
          </Text>
          <Text style={[styles.infoLine, { color: colors.muted }]}>
            "If x²y³ is negative, is x positive?" — you need instant parity/sign recall to crack Data Sufficiency.
          </Text>
        </View>
      </ScrollView>
