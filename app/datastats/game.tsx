    ...
    return (
      <SafeAreaView style={[styles.safe, { backgroundColor: colors.background }]}>
        <View style={styles.center}>
          ...
          <TouchableOpacity
            style={[styles.primaryBtn, { backgroundColor: colors.secondary, borderBottomColor: colors.secondaryDark }]}
            activeOpacity={0.85}
            onPress={playAgain}
          >
      ...
      <View style={styles.optionsArea}>
        ...
        {awaitingNext && (
          <View style={styles.navRow}>
            ...
            <TouchableOpacity
              style={[styles.nextBtn, { flex: 1, backgroundColor: colors.secondary, borderBottomColor: colors.secondaryDark }]}
              activeOpacity={0.85}
              onPress={advanceNext}
            >
